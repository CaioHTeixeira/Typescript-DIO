...
console.log(animal); // const animal: IAnimal = {
//     nome: 'Elefante',
//     tipo: 'terrestre',
...
var input = document.getElementById('input'); // pega o input como um input element;
//é usado assim e não com input: HTMLInputElement = document... pois ele n tem o retorno ainda. Nesse caso usa-se o as.

input.addEventListener('input', function (event) {
  console.log('digitei'); // console.log(event.currentTarget) //não tem .value, devemos indicar ao TS o tipo.
...
var cao = new MeuCachorro('Caio', 5);
cao.idade = 2;
console.log(cao); //--------------------------------------------------------------------------------
...
//# sourceMappingURL=/Estudo%20Typescript.77de5100.js.map